    ...
    <div className="flex flex-col">
      ...
      <div className="border-b   px-4 h-14 sm:h-16 sm:px-20 border-gray-400">
        <div className="flex items-center   h-full gap-2">
          ...
          <div>
            <h1 className="text-blue-500 sm:text-2xl font-semibold">
              User Directory
            </h1>
          </div>
        </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="w-full md:w-auto">
                <button
                  ...
                  className="flex w-full md:w-auto items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
                >
                  <CgUserAdd />
